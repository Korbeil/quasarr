...
class TvTvIdGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'App\\TMDB\\Model\\TvTvIdGetResponse200';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'App\\TMDB\\Model\\TvTvIdGetResponse200';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        $object = new \App\TMDB\Model\TvTvIdGetResponse200();
        ...
        if (\array_key_exists('created_by', $data)) {
            ...
            foreach ($data['created_by'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'App\\TMDB\\Model\\TvTvIdGetResponse200CreatedByItem', 'json', $context);
            }
        ...
        if (\array_key_exists('genres', $data)) {
            ...
            foreach ($data['genres'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'App\\TMDB\\Model\\TvTvIdGetResponse200GenresItem', 'json', $context);
            }
        ...
        if (\array_key_exists('last_episode_to_air', $data)) {
            $object->setLastEpisodeToAir($this->denormalizer->denormalize($data['last_episode_to_air'], 'App\\TMDB\\Model\\TvTvIdGetResponse200LastEpisodeToAir', 'json', $context));
        }
        ...
        if (\array_key_exists('networks', $data)) {
            ...
            foreach ($data['networks'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'App\\TMDB\\Model\\TvTvIdGetResponse200NetworksItem', 'json', $context);
            }
        ...
        if (\array_key_exists('production_companies', $data)) {
            ...
            foreach ($data['production_companies'] as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, 'App\\TMDB\\Model\\TvTvIdGetResponse200ProductionCompaniesItem', 'json', $context);
            }
        ...
        if (\array_key_exists('seasons', $data)) {
            ...
            foreach ($data['seasons'] as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'App\\TMDB\\Model\\TvTvIdGetResponse200SeasonsItem', 'json', $context);
            }
